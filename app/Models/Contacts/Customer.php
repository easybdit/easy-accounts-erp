...
class Customer extends Model
{
    ...
    /**
     * Mirrors Account::balanceAsOf — the running balance for a Customer
     * Statement's opening line is just this called with the day before the
     * statement's "from" date.
     */
