        ...
        <form class="max-w-xl rounded-lg bg-white p-6 shadow-sm" @submit.prevent="submit">
            <div class="space-y-6">
                <div>
                    ...
                    <TextInput id="name" v-model="form.name" type="text" placeholder="e.g. Independence Day" class="mt-1 block w-full" required />
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <PrimaryButton :loading="form.processing">Save Holiday</PrimaryButton>
            </div>
        </form>
    </AppLayout>
</template>
