    ...
    >
        <template #header>
            <PageHeader :title="vendor.name">
                <template #actions>
                    <Link :href="route('reports.vendor-statement', { vendor_id: vendor.id })">
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-4">
            <div class="rounded-lg bg-white p-4 shadow-sm">
                ...
                <p class="text-sm text-gray-800">{{ vendor.email ?? '—' }}</p>
            </div>
            <div class="rounded-lg bg-white p-4 shadow-sm">
            ...
            <div class="rounded-lg bg-white p-4 shadow-sm">
                <p class="text-xs uppercase text-gray-400">Current Balance (Accounts Payable)</p>
