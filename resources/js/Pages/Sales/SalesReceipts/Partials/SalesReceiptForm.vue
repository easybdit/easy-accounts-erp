...
// user can still freely edit any field afterward (mirrors InvoiceForm).
...
// Net (pre-tax) amount posted to the item's account — mirrors InvoiceForm's
// formula. Shown for feedback only; the backend recalculates and is
// authoritative.
...
<template>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr>
                    ...
                    <th class="px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Tax 2</th>
    ...
    <p class="mt-1 text-right text-xs text-gray-400">
        Shown for feedback only — the backend recalculates and is authoritative.
    </p>
